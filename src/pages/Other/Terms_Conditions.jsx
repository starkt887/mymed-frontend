function Terms_Conditions() {
  return (
    <div>
      <h1>Terms and Conditions for Med Repertory</h1>

      <h2>Introduction</h2>

      <p>
        These Website Standard Terms and Conditions written on this webpage
        shall manage your use of our website, https://medrepertory.com
        accessible at https://medrepertory.com.
      </p>
      ...
      <p>
        ...
        <a href="https://www.termsfeed.com/blog/sample-terms-and-conditions-template/">
          Terms And Conditions Sample Template
        </a>
        .
      </p>
      ...
      <p>
        Other than the content you own, under these Terms, Med Repertory and/or
      ...
      <p>
        ...
        and Med Repertory may further restrict access by you to any areas of
      ...
      <p>
        ...
        display on this Website. By displaying Your Content, you grant Med
        Repertory a non-exclusive, worldwide irrevocable, sub licensable license
      ...
      <p>
        ...
        rights. Med Repertory reserves the right to remove any of Your Content
      ...
      <p>
        This Website is provided "as is," with all faults, and Med Repertory
      ...
      <p>
        In no event shall Med Repertory, nor any of its officers, directors and
        ...
        under contract.  Med Repertory, including its officers, directors and
      ...
      <p>
        You hereby indemnify to the fullest extent Med Repertory from and
      ...
      <p>
        Med Repertory is permitted to revise these Terms at any time as it sees
      ...
      <p>
        The Med Repertory is allowed to assign, transfer, and subcontract its
      ...
      <p>
        These Terms constitute the entire agreement between Med Repertory and
